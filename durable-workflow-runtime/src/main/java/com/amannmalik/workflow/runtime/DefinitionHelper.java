...
public final class DefinitionHelper {
  ...
  public static <REQ> ServiceDefinition taskService(
    ...
    return singleVoidHandlerService(
        serviceClass, ServiceType.SERVICE, "execute", HandlerType.SHARED, requestClass, handler);
  }
  ...
  public static <CTX extends Context, REQ> ServiceDefinition singleVoidHandlerService(
    ...
    return singleVoidHandlerService(
        serviceClass.getSimpleName(), serviceType, handlerName, handlerType, requestClass, handler);
  }
    ...
    return ServiceDefinition.of(
        ...
        List.of(
            HandlerDefinition.of(
                ...
                Serde.VOID,
                HandlerRunner.of(
                    handler, JacksonSerdeFactory.DEFAULT, HandlerRunner.Options.DEFAULT))));
  }
}
