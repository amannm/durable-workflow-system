  ...
  void grpcCall() throws Exception {
    ...
    io.grpc.MethodDescriptor<com.amannmalik.grpc.HelloRequest, com.amannmalik.grpc.HelloReply> md =
        io.grpc.MethodDescriptor
            .<com.amannmalik.grpc.HelloRequest, com.amannmalik.grpc.HelloReply>newBuilder()
            .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
            .setFullMethodName(
                io.grpc.MethodDescriptor.generateFullMethodName("GreeterApi.Greeter", "SayHello"))
            .setRequestMarshaller(
                io.grpc.protobuf.ProtoUtils.marshaller(
                    com.amannmalik.grpc.HelloRequest.getDefaultInstance()))
            .setResponseMarshaller(
                io.grpc.protobuf.ProtoUtils.marshaller(
                    com.amannmalik.grpc.HelloReply.getDefaultInstance()))
            .build();

    io.grpc.ServerServiceDefinition service =
        io.grpc.ServerServiceDefinition.builder("GreeterApi.Greeter")
            .addMethod(
                md,
                io.grpc.stub.ServerCalls.asyncUnaryCall(
                    (req, resp) -> {
                      com.amannmalik.grpc.HelloReply reply =
                          com.amannmalik.grpc.HelloReply.newBuilder()
