...
public class SimpleAsyncResult<T> implements AsyncResult<T> {
    ...
    @Override
    public <U> AsyncResult<U> map(dev.restate.common.function.ThrowingFunction<T, CompletableFuture<U>> f,
                                  dev.restate.common.function.ThrowingFunction<dev.restate.sdk.common.TerminalException, CompletableFuture<U>> g) {
